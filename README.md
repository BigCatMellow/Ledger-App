...
- The embedded app/runtime chunks under `assets/` reconstruct the mobile-first Ledger app in the browser.
- `sync.html` writes the latest browser snapshot to the private `BigCatMellow/Notes` repository on the `ledger-data` branch.
